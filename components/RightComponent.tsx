...
const RightComponent = () => {
    return (
        <div className='justify-center items-center'>
            <div className='pt-[4rem] pl-[1.3rem] sm:pl-[20rem] lg:pl-[30rem] xl:pl-[60rem]'>
                ...
                <div className='bg-white w-[22rem] lg:w-[40rem] h-[22.5rem] sm:h-[18.5rem] rounded-md mb-20'>
                ...
                <div className='bg-white w-[22rem] lg:w-[40rem] h-[17.5rem] sm:h-[17.5rem] rounded-md mb-20'>
