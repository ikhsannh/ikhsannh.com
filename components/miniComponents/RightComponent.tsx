                    ...
                    <div className="">
                        ...
                        <div className="px-6 pt-2">
                            ...
                            <div className='flex float-right items-center mr-[-1rem]'>
                                <button className='mr-[0.9rem] mt-[0.8rem]'>
                                    <Link
                                        href='https://nspace.gitbook.io/react-ticketing/'
                                        target='_blank'
                                        title='Visit Documentation Project'
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="float-right w-6 h-6 transition duration-300 ease-in-out transform hover:text-blue-500 hover:scale-110">
                                ...
                                <button className="inline-block">
                                    ...
                                    >
                                        <svg
                                            ...
                                            strokeWidth={1.5}
                                            stroke="currentColor"
                                            className="float-right mt-2 w-6 h-6 transition duration-300 ease-in-out transform hover:text-blue-500 hover:scale-110"
                                        >
                ...
                <div className='bg-white w-[22rem] sm:w-[25rem] lg:w-[40rem] h-[22.5rem] sm:h-[21.5rem] md:h-[21.5rem] lg:h-[19.2rem]  rounded-md mb-20'>
                    ...
                    <div className="">
                        ...
                        <div className="px-6 pt-2">
                            ...
                            <button  className='mr-[0.9rem] mt-[0.9rem]'>
                                <Link
                            ...
                            <button  className='mr-[1rem] mt-[0.5rem]'>
                                <Link
                                    ...
                                    title='Visit Web Project'
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="float-right mt-2 w-6 h-6 transition duration-300 ease-in-out transform hover:text-blue-500 hover:scale-110">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                                    </svg>
                                </Link>
                            </button>       
